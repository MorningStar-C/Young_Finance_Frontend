    ...
    <div class="banner-content">
      ...
      <div class="banner-abs">
        <div class="banner-abs-box">
          <div class="banner-abs-title">Young金融历史年化收益率</div>
    ...
    <div class="content">
      ...
      <div class="new-user" v-for="product in xinShouBao" :key="product.id">
        ...
        <div class="new-user-number">
          ...
          <a href="javascript:void (0)" @click="goLink('/page/product/detail', {id: product.id})" class="new-user-btn">立即投资</a>
        </div>
      ...
      <ul class="preferred-select clearfix">
        <li v-for="(product, index) in youXuan" :key="product.id">
          ...
          <a href="javascript:void (0)" @click="goLink('/page/product/detail', {id: product.id})" class="preferred-select-btn">立即投资</a>
        </li>
      </ul>
